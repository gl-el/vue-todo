...
//первый аргумент - контекст, из него доступны state, getters, commit
//в одном экшене можно применить несколько мутаций
//принято в компонентах изменять стейт именно с помощью экшенов, а не мутаций
const actions = {
  increment(context) {
